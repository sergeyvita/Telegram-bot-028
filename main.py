...
PROMPT = (
    ...
    "5. Предпоследний блок - контактная информация: имя контактного лица, номер телефона, с новой строки - ссылка на WhatsApp, и также с новой строки общий телефон компании **8-800-550-23-93**. "
