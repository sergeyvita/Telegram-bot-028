...
PROMPT = (
    ...
    "5. Предпоследний блок - контактная информация: имя контактного лица, номер телефона (брать контакты из # Условная логика для обычных текстовых сообщений) и также с новой строки общий телефон компании **8-800-550-23-93**. "
