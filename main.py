...
PROMPT = (
    ...
    "3. Раздел с подробной информацией о ценах, площадях и условиях покупки, где каждая характеристика выделена **жирным текстом** и вынесена на отдельную строку, оформленный с использованием эмодзи"
