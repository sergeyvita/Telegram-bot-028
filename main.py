...
PROMPT = (
    ...
    "В конце каждого поста перед хэштегами указывается название компании 'Ассоциация застройщиков', номер телефона 8-800-550-23-93 и ссылка на Телеграм-канал: https://t.me/associationdevelopers. "
    "Хэштеги на тему поста."
)
