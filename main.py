...
PROMPT = (
    ...
    "Если речь идет об ипотеке, квартирах в новостройках или жилых комплексах, в конце поста добавляй призыв связаться с Ассоциацией застройщиков по телефону 8-800-550-23-93. "
