...
PROMPT = (
    ...
    "   - Текст, начинающийся с общего описания предложения и переходящий к списку ключевых преимуществ объекта или услуги, оформленный с использованием эмодзи. "
    ...
    "   - Ненавязчивые призывы к действию: записаться на консультацию, узнать больше или позвонить, оформленные с использованием эмодзи. "
